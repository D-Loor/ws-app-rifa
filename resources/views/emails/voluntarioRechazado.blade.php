...
<body bgcolor="#0f3967" class="generic-template" style="-moz-osx-font-smoothing: grayscale; -webkit-font-smoothing: antialiased; background-color: #0f3967; margin: 0; padding: 0;">
    <!-- Header Start -->
    ...
    <!-- Content Start -->
    <table cellpadding="0" cellspacing="0" cols="1" bgcolor="#0f3967" align="center" style="max-width: 600px;">
        <tr bgcolor="#0f3967">
        ...
        <tr bgcolor="#0f3967">
            <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                <!-- Seperator Start -->
                <table cellpadding="0" cellspacing="0" cols="1" bgcolor="#0f3967" align="center" style="max-width: 600px; width: 100%;">
                    <tr bgcolor="#0f3967">
                ...
                <table align="center" cellpadding="0" cellspacing="0" cols="3" bgcolor="white" class="bordered-left-right" style="border-left: 10px solid #0f3967; border-right: 10px solid #0f3967; max-width: 600px; width: 100%;">
                    ...
                    <tr align="center">
                        ...
                        <td class="text-primary" style="color: #F16522; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                            <h2 style="color: #ff4646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 700; line-height: 28px; margin-bottom: 0; margin-top: 0;">Su solicitud ha sido rechazada</h2>
                        </td>
                        <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                    </tr>
                    ...
                    <tr align="left">
                        ...
                        <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                            ...
                            <br>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;  text-align: justify;">Lamentamos informarle que su solicitud para ser voluntario de la Revolución Ciudadana para el proceso de control electoral ha sido rechazada.</p>
                            <br>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0; text-align: justify;">Su cuenta ha sido rechaza para la participación en el proceso electoral: <strong> {{ $datos['eleccion'] }}</strong>.</p>
                            <br/>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">A continuación, se detallan el motivo de la no aceptación: <br> {{$datos['descripcion']}} <br>
                            <br/>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">Ingrese <strong><a href="https://desarrollo.revolucionciudadana.com.ec/#/login" style="color: inherit; text-decoration: none;">aquí</a></strong> para realizar un nuevo registro. </p>
                            <br/>
