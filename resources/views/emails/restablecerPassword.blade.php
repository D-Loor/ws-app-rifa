                ...
                <table align="center" cellpadding="0" cellspacing="0" cols="3" bgcolor="white" class="bordered-left-right" style="border-left: 10px solid #0f3967; border-right: 10px solid #0f3967; max-width: 600px; width: 100%;">
                    ...
                    <tr align="center">
                        ...
                        <td class="text-primary" style="color: #F16522; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                            <h2 style="color: #ff4646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 700; line-height: 28px; margin-bottom: 0; margin-top: 0;">Restablecimiento de Contraseña</h2>
                        </td>
                        <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                    </tr>
                    ...
                    <tr align="left">
                        ...
                        <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                            ...
                            <br/>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"> Nueva contraseña: <strong> {{ $datos['password'] }}</strong></p>
                            <br/>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0; text-align: justify;">Inicia sesión lo antes posible y cambia esta contraseña temporal por una nueva de tu elección para garantizar la seguridad de tu cuenta.</p>
                            <br/>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">Si no solicitaste el restablecimiento de tu contraseña, contacta a nuestro equipo de soporte inmediatamente.</p>
                            <br/>
